...
response=requests.get('https://api.openweathermap.org/data/2.5/weather?q={}&appid=c007f3fc3a422083d719d41a4a511272'.format(name))
...
weather_kathmandu=pd.DataFrame(weather)
print(weather_kathmandu.head())